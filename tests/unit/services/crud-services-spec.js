...
describe('CRUD Services', () => {
	...
	beforeEach(() => {
        ...
        env.service = sandbox.require('../../../services/lib/crud-services', {
            requires: {
    ...
    describe('create', () => {
        ...
        describe('success', () => {
            ...
            it('should create the stuffs respository', () => {
                expect(env.respository).to.have.been.calledWith('stuffs');
            });
    ...
    describe('read', () => {
        ...
        describe('success', () => {
            beforeEach((done) => {
				...
				env.opts.validators.read.returns(Promise.accept(true));
                env.repo.select.returns(Promise.accept([env.dbstuff]));
    ...
    describe('read all', () => {
        ...
        describe('success', () => {
            beforeEach((done) => {
				env.opts.validators.readAll.returns(Promise.accept(true));
                env.repo.select.returns(Promise.accept([env.dbstuff, env.dbstuff]));
    ...
    describe('update', () => {
        ...
        describe('success', () => {
            beforeEach((done) => {
				env.opts.validators.update.returns(Promise.accept(true));
				env.params.id = 'stuff123';
    ...
    describe('remove', () => {
        ...
        describe('success', () => {
            beforeEach((done) => {
				env.opts.validators.remove.returns(Promise.accept(true));
                env.params.id = 'stuff123';
    ...
    describe('remove all', () => {
        ...
        describe('success', () => {
            beforeEach((done) => {
				env.opts.validators.removeAll.returns(Promise.accept(true));
                env.repo.remove.returns(Promise.accept(true));
